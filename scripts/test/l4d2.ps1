...
# Test CS:GO
& $LOCAL_PATH/test.ps1 -APP_ID_ROOT:550 -APP_ID:222860 -APP_SM_ENGINE:"l4d2" -APP_ENGINE:"left4dead2" -BINARY_APPEND:"_srv" -BASE_PATH:$BASE_PATH -SUPPRESS_BUILD:$SUPPRESS_BUILD