...
# Test CS:GO
& $LOCAL_PATH/test.ps1 -APP_ID_ROOT:440 -APP_ID:232250 -APP_ENGINE:"tf" -BINARY_APPEND:"_srv" -BASE_PATH:$BASE_PATH -SUPPRESS_BUILD:$SUPPRESS_BUILD -EXPORT_BINARIES:$EXPORT_BINARIES