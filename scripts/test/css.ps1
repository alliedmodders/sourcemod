...
& $LOCAL_PATH/test.ps1 -APP_ID_ROOT:240 -APP_ID:232330 -BINARY_APPEND:"_srv" -APP_ENGINE:"cstrike" -BASE_PATH:$BASE_PATH -SUPPRESS_BUILD:$SUPPRESS_BUILD -EXPORT_BINARIES:$EXPORT_BINARIES