...
public void OnPluginStart()
{
	...
	g_Cvar_IncludeMinMaps = CreateConVar("sm_mapvote_include_min", "4", "Specifies the minimum number of maps to include in the vote.", _, true, 0.0, true, 6.0);
...
void CreateNextVote()
{
	...
	if (	g_Cvar_ExcludeMaps.IntValue && tempMaps.Length > g_Cvar_ExcludeMaps.IntValue
		g_Cvar_IncludeMinMaps.IntValue && tempMaps.Length > g_Cvar_IncludeMinMaps.IntValue)
	{
